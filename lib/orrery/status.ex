defmodule Orrery.Status do
  ...
  * A `t:t/0` map, or `nil` when there is no status line.
  ...
  ### Examples
      ...
      iex> Orrery.Status.parse("# Status\\n\\n**Status:** bug fixes only, 2026-09-21\\n\\nSuperseded by Localize.\\n")
  ...
  * A `t:state/0`.
  ...
  ### Examples
      ...
      iex> Orrery.Status.state(nil)
      :active

      iex> Orrery.Status.state(%{state: :archived})
      :archived
  ...
  * A string.
  ...
  ### Examples
      ...
      iex> Orrery.Status.label(:bug_fixes_only)
      "bug fixes only"
  ...
  * A `t:blocker/0`. `:package` and `:requirement` are set only when the text
  ...
  ### Examples
      ...
      iex> Orrery.Status.blocker("localize 1.3.0, expected 2026-10-15")
      %{text: "localize 1.3.0", package: "localize", requirement: ">= 1.3.0", expected: "2026-10-15"}

      iex> Orrery.Status.blocker("unicode_string >= 2.4")
      %{text: "unicode_string >= 2.4", package: "unicode_string", requirement: ">= 2.4.0", expected: nil}

      iex> Orrery.Status.blocker("a decision from the CLDR TC")
