defmodule DashboardWeb.DashboardHTML do
  @moduledoc """
  ...
  static `dashboard.html` written by `mix dashboard.collect`.
  """
  ...
  * The escaped binary.
  ...
  ### Examples
      ...
      iex> DashboardWeb.DashboardHTML.script_safe(~s({"a":"</script><b>&"}))
      ~s({"a":"\\\\u003c/script\\\\u003e\\\\u003cb\\\\u003e\\\\u0026"})
  ...
  * The escaped JSON binary.
  ...
  ### Examples
      ...
      iex> DashboardWeb.DashboardHTML.script_json(%{note: "<x>"})
      ~s({"note":"\\\\u003cx\\\\u003e"})
